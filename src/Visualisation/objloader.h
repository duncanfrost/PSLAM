//need to load obj file with blender and export it in obj using triangulation option
...
class objloader{
        ...
        int load(std::string _basename,const char* filename); //the main model load function
